...
import 'package:intt/categories.dart';
import 'package:intt/leaderboard.dart';
import 'package:intt/login.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () => _scaffoldKey.currentState?.openEndDrawer(), // Using scaffold key
            icon: const Icon(
        ...
        child: ListView(
          ...
          children: [
            const DrawerHeader(
              ...
              child: Image(image: AssetImage("images/spl.png")),
            ),
      ...
      body: Column(
        ...
        children: [
          // Center(
          //   child:
          //       SvgPicture.asset('images/hi.svg.svg', height: 200, width: 80),
          // ),
